...
python entrenamiento.py --tosave ./resultados --cv split_train_test.json --gt ./FORENSE/data_curated_bbox.csv --boxes 3d_boxes.npy --ver ver_lst.npy --opt_mat m_sol_dict_train_final.json --workers 2 --torch_workers 16 --w_out 32 --e_quantile 0.9 --model condresnet18pwise  --dataset midataset_roi --pretrained  --epochs 100 --batch 16 --w_factor=5 --lr 0.0001 --max_translation 0.11 --max_angle 25 --label modelo1_final
